...
public class Ejercicio10 {
    ...
    public static void main(String[] args) {
            //  Implementa un programa para leer los ficheros de texto del ejercicio anterior, de forma que se guarden en una única lista de Vehículos los objetos leídos de cada fichero. El programa debe realizar lo siguiente:
